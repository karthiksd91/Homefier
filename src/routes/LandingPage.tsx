...
export default function LandingPage() {
  ...
  return (
    <div className="h-full flex flex-col bg-slate-950 overflow-y-auto scrollbar-thin">
      {/* Hero */}
      <div className="relative flex flex-col items-center justify-center px-6 text-center overflow-hidden" style={{ minHeight: '100vh' }}>
      ...
      {/* 3D House Preview — separate section so it never overlaps */}
      <div className="relative z-10 bg-slate-950 px-6 py-12 flex justify-center">
        <motion.div
        ...
        >
          <div className="aspect-video glass rounded-2xl border border-white/10 shadow-2xl">
            <HouseSVGPreview />
          </div>
        </motion.div>
      </div>
      ...
      {/* Features */}
      <div className="relative z-10 px-6 py-20 max-w-6xl mx-auto w-full bg-slate-950">
        <motion.div
      ...
      {/* CTA bottom */}
      <div className="relative z-10 px-6 py-16 text-center border-t border-white/5 bg-slate-950">
        <motion.div
          initial={{ opacity: 0 }}
